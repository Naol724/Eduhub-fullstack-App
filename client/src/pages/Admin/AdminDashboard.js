      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Welcome back, {user?.first_name || 'Admin'}! Manage your platform from here.
          </p>
        </div>
            ...
            <div className="space-y-3">
              <button className="w-full text-left px-4 py-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-900 dark:text-white">Add New Course</span>
                </div>
              </button>
              <button className="w-full text-left px-4 py-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200">
                <div className="flex items-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">Course "React Basics" updated</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
              ...
              <span className="text-sm text-green-600 dark:text-green-400">85% Free</span>
            </div>
          </div>
        </div>
      </div>
